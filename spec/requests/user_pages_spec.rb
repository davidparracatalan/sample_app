...
describe "User pages" do
  ...
  describe "profile page" do
    ...
    describe "follow/unfollow buttons" do
      ...
      describe "following a user"do
        ...
        it "should increment the user followed count by 1" do
          expect do
            click_button "Follow"
          end.to change(user.followed_users, :count).by(1)
        end

        it "should increment the other user's followers count by 1" do
          expect do
            click_button "Follow"
      ...
      describe "unfollowing a user" do
        ...
        it "should decrement the user followed count by 1" do
          expect do
              click_button "Unfollow"
          end.to change(user.followed_users, :count).by(-1)
        end
        it "should decrement the other user's followers count by 1" do
          expect do
            click_button "Unfollow"
          end.to change(other_user.followers, :count).by(-1)
        end
  ...
  describe "edit" do
    ...
    let(:new_email) {"nweemail@example.com"}
    before do
